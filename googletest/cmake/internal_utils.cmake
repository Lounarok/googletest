...
macro(fix_default_compiler_settings_)
  if (CMAKE_CXX_COMPILER_ID MATCHES "MSVC|Clang")
    ...
    foreach (flag_var
      ...
      if (NOT BUILD_SHARED_LIBS AND NOT gtest_force_shared_crt AND NOT MSVC_RUNTIME_LIBRARY)
        # Following behavior should be only applicable before CMP0091 enabled:
